            ...
            <div class="col-md-6 mt-24">
                ...
                <div class="widget-media-3 h-full">
                    ...
                    <div class="widget-body">
                        <h5 class="widget-title font-weight-500">Vouz avez {{$products}} @if ($products > 1)
                            produits
                        @else
                        produit
                        @endif </h5>
                        <a  href="{{route('products.create')}}" role="button" class="btn btn-has-icon btn-dark font-weight-300">
